...
# v5版本专用 选择ae参数
parser.add_argument("--ae_version", type=int, default=3, help="ae权重版本,2为1e-8  3为1e-4 4为1e-5")
...
name_project = "train_resnet18_byvirtual_v1"
...
for epoch in range(args.epochs):
    ...
    for batch_idx, (data, label) in enumerate(trainloader_cifar10):
        ...
        data_virtual, label_virtual = model_g.generate_virtual(data, label, set_encoded_detach=True,
